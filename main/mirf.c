...
#define CONFIG_MISO_GPIO 47 // 47
#define CONFIG_MOSI_GPIO GPIO_NUM_19 // 19
#define CONFIG_SCLK_GPIO 46 // 46
#define CONFIG_CE_GPIO 45 //45
#define CONFIG_CSN_GPIO GPIO_NUM_20 //20
